...
;(function(window) {
	...
	Stack.prototype.acceptToday = function(callback) {
		this._next('acceptToday', callback);
	};

	Stack.prototype.acceptSomeday = function(callback) {
		this._next('acceptSomeday', callback);
	};
	...
	Stack.prototype._next = function(action, callback) {
		...
		// add animation class
		classie.add(currentItem, action === 'accept' ? 'stack__item--accept' : ( action === 'acceptToday' ? 'stack__item--accept-today' : ( action === 'acceptSomeday' ? 'stack__item--accept-someday' : 'stack__item--reject')));


		// add animation class
		//classie.add(currentItem, action === 'acceptToday' ? 'stack__item--accept-today' : 'stack__item--reject');
